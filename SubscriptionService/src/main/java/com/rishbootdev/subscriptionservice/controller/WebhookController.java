...
public class WebhookController {
    ...
    public ResponseEntity<String> handleRazorpayWebhook(HttpServletRequest request, @RequestHeader(HttpHeaders.AUTHORIZATION) String authHeader) throws Exception {
        ...
        try {
            ...
            if ("payment.captured".equals(event)) {
                ...
                paymentService.verifyPayment(razorpayOrderId, razorpayPaymentId, "WEBHOOK_VERIFIED");
            }
